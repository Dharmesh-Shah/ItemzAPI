...
-- DO NOT UPDATE THIS FILE ANYMORE AS NEW VERSION HAS BEEN INTRODUCED AND THIS SHOULD NOT BE TOUCHED
-- TO MAKE SURE THAT EF CORE MIGRATIONS CONTINUE TO WORK FOR OLDER MIGRATIONS THAT NEEDED THIS FILE,
-- WE DECIDED TO MOVE IT INTO OBSOLETE FOLDER TO SUPPORT WALKING THROUGH MIGRATION HISTORY WITHOUT 
-- ENCOUNTERING ERRORS WHILE DATABASE GETS INITIALLIZED AT THE START OF THE APPLICATION.
