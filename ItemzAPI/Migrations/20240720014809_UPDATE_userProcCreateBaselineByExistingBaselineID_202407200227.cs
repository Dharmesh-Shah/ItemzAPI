...
{
    /// <inheritdoc />
    public partial class UPDATE_userProcCreateBaselineByExistingBaselineID_202407200227 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcCreateBaselineByExistingBaselineID_202407200227.sql")
                        );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcCreateBaselineByExistingBaselineID_202407161706.sql")
                        );
            foreach (var sqlFile in sqlFiles)
            {
                using (Stream? stream = assembly.GetManifestResourceStream(sqlFile))
