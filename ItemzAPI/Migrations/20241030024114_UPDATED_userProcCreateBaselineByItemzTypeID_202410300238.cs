...
{
    /// <inheritdoc />
    public partial class UPDATED_userProcCreateBaselineByItemzTypeID_202410300238 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcCreateBaselineByItemzTypeID_202410300238.sql")
						);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
			...
			// Stored Procedure.
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcCreateBaselineByItemzTypeID_202407262359.sql")
						);
			foreach (var sqlFile in sqlFiles)
			{
				using (Stream? stream = assembly.GetManifestResourceStream(sqlFile))
