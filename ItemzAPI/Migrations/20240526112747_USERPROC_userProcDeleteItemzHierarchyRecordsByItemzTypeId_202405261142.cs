...
{
    /// <inheritdoc />
    public partial class USERPROC_userProcDeleteItemzHierarchyRecordsByItemzTypeId_202405261142 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteItemzHierarchyRecordsByItemzTypeId_202405261142.sql")
                        );
        ...
        {
            var dropuserProcCreateBaselineByProjectID = "DROP PROC userProcDeleteItemzHierarchyRecordsByItemzTypeId";
