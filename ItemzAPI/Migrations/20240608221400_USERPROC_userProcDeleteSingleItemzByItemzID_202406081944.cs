...
{
    /// <inheritdoc />
    public partial class USERPROC_userProcDeleteSingleItemzByItemzID_202406081944 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteSingleItemzByItemzID_202406081944.sql")
                        );
