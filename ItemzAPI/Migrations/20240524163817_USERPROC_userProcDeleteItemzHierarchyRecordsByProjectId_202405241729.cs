...
{
    /// <inheritdoc />
    public partial class USERPROC_userProcDeleteItemzHierarchyRecordsByProjectId_202405241729 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteItemzHierarchyRecordsByProjectId_202405241729.sql")
                        );
        ...
        {
            var dropuserProcCreateBaselineByProjectID = "DROP PROC userProcDeleteItemzHierarchyRecordsByProjectId";
