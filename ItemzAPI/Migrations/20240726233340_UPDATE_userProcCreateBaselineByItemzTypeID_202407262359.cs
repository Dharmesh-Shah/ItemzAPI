...
{
    /// <inheritdoc />
    public partial class UPDATE_userProcCreateBaselineByItemzTypeID_202407262359 : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcCreateBaselineByItemzTypeID_202407200226.sql")
                        );
            foreach (var sqlFile in sqlFiles)
            {
                using (Stream? stream = assembly.GetManifestResourceStream(sqlFile))
