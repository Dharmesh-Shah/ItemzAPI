...
{
    /// <inheritdoc />
    public partial class UPDATE_userProcDeleteAllOrphanedBaselineItemz_202407251305 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteAllOrphanedBaselineItemz_202407251305.sql")
                        );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteAllOrphanedBaselineItemz_202404210107")
                        );
            foreach (var sqlFile in sqlFiles)
            {
                using (Stream? stream = assembly.GetManifestResourceStream(sqlFile))
