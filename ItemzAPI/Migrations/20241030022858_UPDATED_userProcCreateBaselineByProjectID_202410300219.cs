...
{
    /// <inheritdoc />
    public partial class UPDATED_userProcCreateBaselineByProjectID_202410300219 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			...
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcCreateBaselineByProjectID_202410300219.sql")
						);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
			...
			// Stored Procedure.
			var sqlFiles = assembly.GetManifestResourceNames().
						Where(file => file.EndsWith("userProcCreateBaselineByProjectID_202407262355.sql")
						);
			foreach (var sqlFile in sqlFiles)
			{
				using (Stream? stream = assembly.GetManifestResourceStream(sqlFile))
