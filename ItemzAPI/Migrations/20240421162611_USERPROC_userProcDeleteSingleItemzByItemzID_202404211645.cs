...
{
    public partial class USERPROC_userProcDeleteSingleItemzByItemzID_202404211645 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteSingleItemzByItemzID_202404211645.sql")
                        );
        ...
        {
            var dropuserProcCreateBaselineByProjectID = "DROP PROC userProcDeleteSingleItemzByItemzID";
