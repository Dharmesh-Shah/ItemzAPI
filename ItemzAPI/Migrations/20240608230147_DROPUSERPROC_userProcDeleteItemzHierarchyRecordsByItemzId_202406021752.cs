...
{
    /// <inheritdoc />
    public partial class DROPUSERPROC_userProcDeleteItemzHierarchyRecordsByItemzId_202406021752 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var dropuserProcCreateBaselineByProjectID = "DROP PROC userProcDeleteItemzHierarchyRecordsByItemzId";
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteItemzHierarchyRecordsByItemzId_202406021752.sql")
                        );
