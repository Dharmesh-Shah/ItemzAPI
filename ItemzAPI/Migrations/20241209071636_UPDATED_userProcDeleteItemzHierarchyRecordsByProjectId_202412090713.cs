...
{
    /// <inheritdoc />
    public partial class UPDATED_userProcDeleteItemzHierarchyRecordsByProjectId_202412090713 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteItemzHierarchyRecordsByProjectId_202412090713.sql")
                        );
