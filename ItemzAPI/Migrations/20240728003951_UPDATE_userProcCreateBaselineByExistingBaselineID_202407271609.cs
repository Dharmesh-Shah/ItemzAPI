...
{
    /// <inheritdoc />
    public partial class UPDATE_userProcCreateBaselineByExistingBaselineID_202407271609 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcCreateBaselineByExistingBaselineID_202407271609.sql")
                        );
