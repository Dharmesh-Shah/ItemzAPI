...
{
    /// <inheritdoc />
    public partial class UPDATED_userProcDeleteItemzHierarchyRecordsByItemzTypeId_202412091028 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteItemzHierarchyRecordsByItemzTypeId_202412091028.sql")
                        );
