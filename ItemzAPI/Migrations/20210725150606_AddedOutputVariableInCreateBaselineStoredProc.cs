...
{
    public partial class AddedOutputVariableInCreateBaselineStoredProc : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcCreateBaselineByProjectID.sql")
                        || file.EndsWith("userProcCreateBaselineByItemzTypeID.sql")
                        );
