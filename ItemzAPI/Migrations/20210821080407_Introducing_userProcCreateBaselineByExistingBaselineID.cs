...
{
    public partial class Introducing_userProcCreateBaselineByExistingBaselineID : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        ...
                        || file.EndsWith("userProcUpdateBaselineItemz.sql")
                        || file.EndsWith("userProcCreateBaselineByExistingBaselineID.sql")
                        );
