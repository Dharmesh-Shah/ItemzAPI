...
{
    public partial class USERPROC_userProcDeleteAllOrphanedBaselineItemz_202404210107 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteAllOrphanedBaselineItemz_202404210107.sql")
                        );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            var sqlFiles = assembly.GetManifestResourceNames().
                        Where(file => file.EndsWith("userProcDeleteAllOrphanedBaselineItemz.sql")
                        );
            foreach (var sqlFile in sqlFiles)
            {
                using (Stream? stream = assembly.GetManifestResourceStream(sqlFile))
