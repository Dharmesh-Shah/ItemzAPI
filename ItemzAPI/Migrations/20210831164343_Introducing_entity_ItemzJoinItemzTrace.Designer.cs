...
namespace ItemzApp.API.Migrations
{
    ...
    [Migration("20210831164343_Introducing_entity_ItemzJoinItemzTrace")]
    partial class Introducing_entity_ItemzJoinItemzTrace
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemzApp.API.Entities.Itemz", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "User 1",
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 30, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "User 2",
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 7, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 30, 0, 0)),
                            Description = "Requirements to be described here.",
                            Name = "Item 2",
                            Priority = "Medium",
                            Severity = "Medium",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "User 3",
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 30, 0, 0)),
                            Description = "Requirements to be described here.",
                            Name = "Item 3",
                            Priority = "Low",
                            Severity = "Medium",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "User 4",
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 7, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 30, 0, 0)),
                            Description = "Requirements to be described here.",
                            Name = "Item 4",
                            Priority = "Low",
                            Severity = "Medium",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "User 5",
                            CreatedDate = new DateTimeOffset(new DateTime(2019, 7, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 5, 30, 0, 0)),
                            Description = "Requirements to be described here.",
                            Name = "Item 5",
                            Priority = "Low",
                            Severity = "Medium",
            ...
            modelBuilder.Entity("ItemzApp.API.Entities.Itemz", b =>
                {
                    b.Navigation("FromItemzJoinItemzTrace");

                    b.Navigation("ItemzTypeJoinItemz");

                    b.Navigation("ToItemzJoinItemzTrace");
                });
